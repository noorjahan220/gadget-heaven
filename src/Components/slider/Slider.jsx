  ...
  return (
   ...
   <h2 className="text-3xl text-center font-bold m-10 border-b-2">Our Clients Comments</h2>
    <div ref={sliderRef} className="keen-slider">
      <div className=" card mb-4 pt-10 px-20 bg-white flex flex-col items-center keen-slider__slide number-slide1">
        
        <img className="w-16" src="https://i.ibb.co.com/xf2Cn2n/images.jpg" alt="" />
        <p>The website is incredibly user-friendly, and the design is sleek and modern. Navigating through the products was smooth and efficient. I was able to find the perfect gadget in no time!</p>
      ...
      <div className=" card mb-4 pt-10 px-20 bg-white flex flex-col items-center keen-slider__slide number-slide1">
        ...
        <img className="w-16" src="https://i.ibb.co.com/xf2Cn2n/images.jpg" alt="" />
        <p>I’m really impressed with the clear product descriptions and detailed specifications. It made comparing gadgets much easier. My shopping experience was seamless and hassle-free.</p>
      ...
      <div className=" card mb-4 pt-10 px-20 bg-white flex flex-col items-center keen-slider__slide number-slide1">
        ...
        <img className="w-16" src="https://i.ibb.co.com/xf2Cn2n/images.jpg" alt="" />
        <p>The gadget collection on this site is fantastic! The well-organized categories and filters helped me find exactly what I needed. I’ll definitely be returning for future purchases!</p>
      ...
      <div className=" card mb-4 pt-10 px-20 bg-white flex flex-col items-center keen-slider__slide number-slide1">
        ...
        <img className="w-16" src="https://i.ibb.co.com/xf2Cn2n/images.jpg" alt="" />
        <p>This site loads incredibly fast and performs flawlessly across all my devices. The responsive design ensures a smooth experience whether I'm on my phone or computer.</p>
      ...
      <div className=" card mb-4 pt-10 px-20 bg-white flex flex-col items-center keen-slider__slide number-slide1">
        ...
        <img className="w-16" src="https://i.ibb.co.com/xf2Cn2n/images.jpg" alt="" />
        <p>The 'View Details' button on each product card is a brilliant feature. It allows for quick access to important information, making the browsing experience much more convenient.</p>
        <img className="w-32 rounded-full" src="https://i.ibb.co.com/LvPGJqM/images-2.jpg" alt="" />
      ...
      <div className=" card mb-4 pt-10 px-20 bg-white flex flex-col items-center keen-slider__slide number-slide1">
        ...
        <img className="w-16" src="https://i.ibb.co.com/xf2Cn2n/images.jpg" alt="" />
        <p>I had a wonderful experience shopping on this website! The layout is intuitive, and the functionality is top-notch, which made my entire purchase process enjoyable.</p>
